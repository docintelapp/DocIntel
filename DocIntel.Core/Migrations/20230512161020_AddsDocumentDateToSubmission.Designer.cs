...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollectorGroup", b =>
                {
                    b.Property<Guid>("CollectorReleasableToCollectorId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ReleasableToGroupId")
                        .HasColumnType("uuid");

                    b.HasKey("CollectorReleasableToCollectorId", "ReleasableToGroupId");

                    b.HasIndex("ReleasableToGroupId");

                    b.ToTable("CollectorRelToGroup", (string)null);
                });

            modelBuilder.Entity("CollectorGroup1", b =>
                {
                    b.Property<Guid>("CollectorEyesOnlyCollectorId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("EyesOnlyGroupId")
                        .HasColumnType("uuid");

                    b.HasKey("CollectorEyesOnlyCollectorId", "EyesOnlyGroupId");

                    b.HasIndex("EyesOnlyGroupId");

                    b.ToTable("CollectorGroupEyesOnly", (string)null);
                });

            modelBuilder.Entity("CollectorTag", b =>
                {
                    b.Property<Guid>("CollectorsCollectorId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("TagsTagId")
                        .HasColumnType("uuid");

                    b.HasKey("CollectorsCollectorId", "TagsTagId");

                    b.HasIndex("TagsTagId");

                    b.ToTable("CollectorTags", (string)null);
                });
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Collector", b =>
                {
                    ...
                    b.Property<bool>("ImportStructuredData")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("CollectorGroup", b =>
                {
                    b.HasOne("DocIntel.Core.Models.Collector", null)
                        .WithMany()
                        .HasForeignKey("CollectorReleasableToCollectorId")
            ...
            modelBuilder.Entity("CollectorGroup1", b =>
                {
                    b.HasOne("DocIntel.Core.Models.Collector", null)
                        .WithMany()
                        .HasForeignKey("CollectorEyesOnlyCollectorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
