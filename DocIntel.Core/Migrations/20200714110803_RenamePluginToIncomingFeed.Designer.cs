...
namespace DocIntel.Core.Migrations
{
    ...
    [Migration("20200714110803_RenamePluginToIncomingFeed")]
    partial class RenamePluginToIncomingFeed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocIntel.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Activity", b =>
                {
                    b.HasOne("DocIntel.Models.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Comment", b =>
                {
                    b.HasOne("DocIntel.Models.AppUser", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Document", b =>
                {
                    b.HasOne("DocIntel.Models.AppUser", "LastModifiedBy")
                        .WithMany()
                        .HasForeignKey("LastModifiedById");

                    b.HasOne("DocIntel.Models.AppUser", "RegisteredBy")
                        .WithMany()
            ...
            modelBuilder.Entity("DocIntel.Core.Models.InboxItem", b =>
                {
                    b.HasOne("DocIntel.Models.AppUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("DocIntel.Core.Models.IncomingFeed", b =>
                {
                    b.HasOne("DocIntel.Core.Models.ImportRuleSet", null)
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Notification", b =>
                {
                    ...
                    b.HasOne("DocIntel.Models.AppUser", "Recipient")
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Tag", b =>
                {
                    b.HasOne("DocIntel.Models.AppUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DocIntel.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
