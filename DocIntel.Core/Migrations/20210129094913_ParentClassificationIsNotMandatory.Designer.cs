...
namespace DocIntel.Core.Migrations
{
    ...
    [Migration("20210129094913_ParentClassificationIsNotMandatory")]
    partial class ParentClassificationIsNotMandatory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocIntel.Core.Models.EyesOnly", b =>
                {
                    b.Property<Guid>("EyesOnlyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("DocumentFileFileId")
                        .HasColumnType("uuid");
                    ...
                    b.HasAlternateKey("DocumentId", "GroupId");

                    b.HasIndex("DocumentFileFileId");
            ...
            modelBuilder.Entity("DocIntel.Core.Models.ReleasableTo", b =>
                {
                    b.Property<Guid>("ReleasableToId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DocIntel.Core.Models.EyesOnly", b =>
                {
                    b.HasOne("DocIntel.Core.Models.DocumentFile", null)
                        .WithMany("EyesOnly")
                        .HasForeignKey("DocumentFileFileId");
            ...
            modelBuilder.Entity("DocIntel.Core.Models.OrderedImportRuleSet", b =>
                {
                    ...
                    b.Navigation("IncomingFeed");
                });

            modelBuilder.Entity("DocIntel.Core.Models.ReleasableTo", b =>
                {
                    b.HasOne("DocIntel.Core.Models.DocumentFile", null)
                        .WithMany("ReleasableTo")
                        .HasForeignKey("DocumentFileFileId");
                    ...
                    b.HasOne("DocIntel.Core.Models.Group", "Group")
                        .WithMany("DocumentsReleasableTo")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Document", b =>
                {
                    ...
                    b.Navigation("EyesOnly");

                    b.Navigation("Files");

                    b.Navigation("ReleasableTo");
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Group", b =>
                {
                    b.Navigation("DocumentsEyesOnly");

                    b.Navigation("DocumentsReleasableTo");
