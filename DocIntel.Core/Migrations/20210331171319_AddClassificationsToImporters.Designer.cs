...
namespace DocIntel.Core.Migrations
{
    ...
    [Migration("20210331171319_AddClassificationsToImporters")]
    partial class AddClassificationsToImporters
    {
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Group", b =>
                {
                    ...
                    b.Property<Guid?>("ScraperId1")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("SubmittedDocumentId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("SubmittedDocumentId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ImporterId1");

                    b.HasIndex("ParentGroupId");

                    b.HasIndex("ScraperId");

                    b.HasIndex("ScraperId1");

                    b.HasIndex("SubmittedDocumentId");

                    b.HasIndex("SubmittedDocumentId1");
            ...
            modelBuilder.Entity("DocIntel.Core.Models.Group", b =>
                {
                    ...
                    b.HasOne("DocIntel.Core.Models.SubmittedDocument", null)
                        .WithMany("ReleasableTo")
                        .HasForeignKey("SubmittedDocumentId1");
