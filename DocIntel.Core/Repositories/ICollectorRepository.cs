...
{
    /// <summary>
    ///     Provides a data abstraction layer for collectors. The repository
    ...
    {
        /// <summary>
        ///     Creates a new collector in the repository.
        /// </summary>
        ...
        ///     data annotations.
        /// </exception>
        Task<Collector> CreateAsync(AmbientContext ambientContext, 
            Collector feed);

        /// <summary>
        ///     Updates an existing collector in the repository.
        /// </summary>
        ...
        /// </exception>
        Task<Collector> UpdateAsync(AmbientContext ambientContext, 
            Collector feed);

        /// <summary>
        ///     Removes an existing collector in the repository.
        /// </summary>
        /// <param name="feedId">
        ...
        ///     Thrown when the specified feed is not known in the repository.
        /// </exception>
        Task<Collector> RemoveAsync(AmbientContext ambientContext, 
            Guid feedId);

        /// <summary>
        ///     Returns whether an collector that the user has the right to view
        ...
        ///     Thrown when the specified feed is not known in the repository.
        /// </exception>
        Task<Collector> GetAsync(AmbientContext ambientContext, 
            Guid feedId, 
            Func<IQueryable<Collector>,IQueryable<Collector>> includes = null);

        /// <summary>
        ///     Returns the list of collectors that the user has the right to
        ///     view.
        /// </summary>
        /// <param name="user">The user requesting the check.</param>
        /// <param name="includeRelatedData">
        ...
        ///     collector in the repository.
        /// </exception>
        IAsyncEnumerable<Collector> GetAllAsync(AmbientContext ambientContext,
