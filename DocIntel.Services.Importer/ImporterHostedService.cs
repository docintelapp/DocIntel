...
{
    class ImporterHostedService : DocIntelHostedService
    {
        protected override string WorkerName => "Document Importer";

        public ImporterHostedService(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        }
