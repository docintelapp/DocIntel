...
{
    internal class FacetIndexerHostedService : DocIntelHostedService
    {
        public FacetIndexerHostedService(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        }

        protected override string WorkerName => "Facet Indexer";
