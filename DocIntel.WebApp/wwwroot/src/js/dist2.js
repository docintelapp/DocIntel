...
import '@amcharts/amcharts5-geodata'
import '@amcharts/amcharts5-fonts';
*/
...
export function initSummernote() {
}
    ...
    function formatTag(tag) {
        ...
        if (tag.label) {
            return "<div class='clearfix d-flex'>" +
                ...
                (tag.facet && tag.facet.prefix ? tag.facet.prefix + ":" : "") + tag.label + "</span></div>" +
            '</div>';
        }
    }
...
export function displayQRCode(elementId, text) {
