...
namespace DocIntel.Services.DocumentIndexer
{
        ...
        IConsumer<SourceMergedMessage>
    {
        ...
        private readonly ILogger<IndexerConsumer> _logger;

        private readonly IUserClaimsPrincipalFactory<AppUser> _userClaimsPrincipalFactory;
        private readonly ApplicationSettings _appSettings;
        private readonly IServiceProvider _serviceProvider;

        public IndexerConsumer(ILogger<IndexerConsumer> logger,
            IDocumentRepository documentRepository,
            IDocumentIndexingUtility indexingUtility,
            IUserClaimsPrincipalFactory<AppUser> userClaimsPrincipalFactory, ApplicationSettings appSettings,
        ...
        {
            using var ambientContext = GetAmbientContext();
        ...
        public Task Consume(ConsumeContext<DocumentRemovedMessage> context)
        {
        ...
        private AmbientContext GetAmbientContext()
        {
            ...
            try
            {
                ...
                var automationUser = dbContext.Users.FirstOrDefault(_ => _.UserName == _appSettings.AutomationAccount);
                ...
                ambientContext = new AmbientContext
                    {DatabaseContext = dbContext, Claims = claims, CurrentUser = automationUser};
            }
            catch (Exception e)
            {
